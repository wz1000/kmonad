...
-- import System.Keyboard hiding (Name, Keycode)
...
-- pickInput :: InputToken -> J InputCfg
-- pickInput _ = pure def
...
-- pickOutput :: OutputToken -> J OutputCfg
-- pickOutput _ = pure def
-- -- (Uinput _ _) = pure $ LinuxUinputCfg $ def
--   -- { _keyboardName = "hello"
