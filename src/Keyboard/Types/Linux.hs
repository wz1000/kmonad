...
-- NOTE: I think I might be able to better represent the relationship between
-- Packet and LowLinEvent using a prism, instead of all these newtypes.
